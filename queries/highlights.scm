...
(extend
	target: (expression (literal (identifier))) @type
)
(extend
	tobe: (expression (literal (identifier))) @type
)

(function
	return_type: (expression (literal (identifier))) @type
)
(function_call
	callee: (expression (literal (identifier))) @function.call
)
(function_call
